...
namespace LiquidState
{
    ...
    {
        public static StateMachine<TState, TTrigger> Create<TState, TTrigger>(TState initialState, StateMachineConfiguration<TState, TTrigger> config)
        {
        ...
        public static AsyncStateMachine<TState, TTrigger> Create<TState, TTrigger>(TState initialState, AsyncStateMachineConfiguration<TState, TTrigger> config)
        {
            Contract.Requires<ArgumentNullException>(initialState != null);
            Contract.Requires<ArgumentNullException>(config != null);
